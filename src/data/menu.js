...
export const MENU_ITEMS = [
  ...
  },
  {
    ...
    note: {
      en: 'Chicken feet can be added or left out.',
      my: 'ကြက်ခြေထောက် ထည့်/မထည့် ရွေးချယ်နိုင်ပါသည်',
    },
  },
  {
    id: 'claypot-noodle',
  ...
  },
  {
    ...
    inStock: true,
    photo: 'shanNoodles',
    name: { en: 'Shan Noodle', my: 'ရှမ်းခေါက်ဆွဲ' },
    blurb: { en: 'Shan noodles with soup and sides.', my: 'ဟင်းရည်နှင့် အကြော်တို့နှင့် ရှမ်းခေါက်ဆွဲ။' },
  },
  {
    id: 'mee-shay-salad',
    category: 'noodles',
    ...
    inStock: true,
    photo: 'meeShaySalad',
    name: { en: 'Mee Shay Salad', my: 'မြီးရှည်သုပ်' },
    blurb: { en: 'Mee shay tossed as a salad.', my: 'သုပ်ထားသော မြီးရှည်။' },
  },
  {
