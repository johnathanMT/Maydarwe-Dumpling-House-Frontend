...
export default function CtaBanner({ eyebrow, title, body, children, className = '' }) {
  return (
    <Reveal
      className={`relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 px-6 py-10 text-white shadow-lift sm:px-10 md:flex md:items-center md:justify-between md:gap-8 lg:px-14 lg:py-14 ${className}`}
    >
      ...
      <div className="relative">
        ...
        {body ? <p className="mt-3 max-w-xl text-primary-50/90">{body}</p> : null}
      </div>
