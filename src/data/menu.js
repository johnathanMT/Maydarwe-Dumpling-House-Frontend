...
export const MENU_ITEMS = [
  ...
  {
    id: 'spicy-noodle-dumpling',
    category: 'dumplings',
    meatType: null,
    price: 18000,
    inStock: true,
    photo: 'spicyNoodleDumpling',
    name: { en: 'Spicy Noodle Dumpling', my: 'စပိုက်ဆီခေါက်ဆွဲ ဖက်ထုပ်' },
    blurb: { en: 'Dumplings served with spicy oil noodles.', my: 'စပိုက်ဆီခေါက်ဆွဲနှင့် ဖက်ထုပ်။' },
  },
  {
    id: 'dumpling-soup',
    category: 'dumplings',
  ...
  },
  {
    ...
    name: { en: 'Black Chicken Mala', my: 'ကြက်မဲမာလာ' },
    blurb: { en: 'Black chicken in fragrant mala.', my: 'မာလာနှင့် ကြက်မဲ။' },
  },
  {
    ...
    name: { en: 'Spicy Noodle Salad', my: 'စပိုက်ဆီခေါက်ဆွဲသုပ်' },
