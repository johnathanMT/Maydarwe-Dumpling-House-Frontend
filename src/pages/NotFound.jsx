...
export default function NotFound() {
  ...
  return (
    <section className="bg-sunny">
      <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-20 text-center sm:px-6 lg:py-28">
        ...
        <p className="mt-4 max-w-md text-lg leading-relaxed text-ink-600">{t('ui.notFound.body')}</p>
        <div className="mt-8 flex w-full flex-col justify-center gap-3 sm:w-auto sm:flex-row">
          <Button as={Link} to="/menu" magnetic>
